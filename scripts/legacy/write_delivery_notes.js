...
fs.mkdirSync("app/dashboard/delivery-notes", { recursive: true });
fs.writeFileSync("app/dashboard/delivery-notes/page.tsx", page, "utf8");
console.log("Done:", fs.statSync("app/dashboard/delivery-notes/page.tsx").size, "bytes");
