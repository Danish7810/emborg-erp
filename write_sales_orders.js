...
fs.mkdirSync("app/dashboard/sales-orders", { recursive: true });
fs.writeFileSync("app/dashboard/sales-orders/page.tsx", page, "utf8");
console.log("Done:", fs.statSync("app/dashboard/sales-orders/page.tsx").size, "bytes");
