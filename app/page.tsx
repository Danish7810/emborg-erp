...
export default function Home() {
  ...
  return (
    <main>
      <section style={{ padding: "100px 40px 40px", display: "flex", alignItems: "center", gap: "60px", maxWidth: "1200px", margin: "0 auto", flexWrap: "wrap" }}>
      ...
      <section style={{ padding: "0 40px 80px", maxWidth: "700px", margin: "0 auto" }} className="fade-up">
