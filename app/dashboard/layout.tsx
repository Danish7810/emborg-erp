...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const sections = [
    ...
    { label: "Operations", items: [{ label: "Suppliers", href: "/dashboard/suppliers" }, { label: "Purchase Orders", href: "/dashboard/purchase-orders" }, { label: "Delivery Notes", href: "/dashboard/delivery-notes" }, { label: "Stock Ledger", href: "/dashboard/stock-ledger" }, { label: "Inventory", href: "/dashboard/inventory" }, { label: "Warehouses", href: "/dashboard/warehouses" }, { label: "Finance", href: "/dashboard/finance" }, { label: "Payment Entries", href: "/dashboard/payments" }, { label: "Journal Entries", href: "/dashboard/journal-entries" }, { label: "Reports", href: "/dashboard/reports" }, { label: "HR and Payroll", href: "/dashboard/hr" }, { label: "Team Settings", href: "/dashboard/settings" }] },
  ];
