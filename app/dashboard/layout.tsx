...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const sections = [
    ...
    { label: "Operations", items: [{ label: "Inventory", href: "/dashboard/inventory" }, { label: "Finance", href: "/dashboard/finance" }, { label: "Reports", href: "/dashboard/reports" }, { label: "HR and Payroll", href: "/dashboard/hr" }] },
  ];
