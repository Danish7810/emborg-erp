...
fs.mkdirSync("app/dashboard/reports", { recursive: true });
fs.writeFileSync("app/dashboard/reports/page.tsx", reports, "utf8");
console.log("Done:", fs.statSync("app/dashboard/reports/page.tsx").size, "bytes");
