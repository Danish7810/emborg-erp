...
fs.mkdirSync("app/dashboard/stock-ledger", { recursive: true });
fs.writeFileSync("app/dashboard/stock-ledger/page.tsx", page, "utf8");
console.log("Done:", fs.statSync("app/dashboard/stock-ledger/page.tsx").size, "bytes");
