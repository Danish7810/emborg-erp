...
fs.mkdirSync("app/dashboard/journal-entries", { recursive: true });
fs.writeFileSync("app/dashboard/journal-entries/page.tsx", page, "utf8");
console.log("Done:", fs.statSync("app/dashboard/journal-entries/page.tsx").size, "bytes");
